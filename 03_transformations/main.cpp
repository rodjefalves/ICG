...
void Display(void) {
    ...
    // Referente as mudanças na câmera
    float camera_position[3]  = {0.3f, 0.0f, 0.1f},
          camera_up[3]   = {0.0f, 1.0f, 0.0f},
          camera_pointer[3] = {0.0f, 0.0f, -1.0f};
